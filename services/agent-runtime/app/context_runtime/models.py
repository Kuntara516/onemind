...
class ContextBudget(BaseModel):
    ...
    def used_tokens(self) -> int:
        ...
        Existing runtime components use:
            budget.used_tokens
...
class ContextCandidate(BaseModel):
    ...
    Used by ranking algorithms for:
    - keyword matching
    - semantic scoring
    - relevance calculation

    Optional because some retrieval sources
    may only return metadata initially.
    """
    ...
    Populated by retriever when mapping
    ContextRuntimeState -> ContextCandidate.
    """
